...
import ContenAccueil from "./composants/content-accueil";
import Articles_Accueil from "./composants/article-accueil";
import { Route, Routes } from "react-router-dom";
import Articles from "./composants/Articles/articles";
import Apropos from "./composants/pages/a-propos";
import Tecnologies from "./composants/pages/technologie.jsx";
import ArticleElem from "./composants/Articles/articlesElementaire.jsx";
      ...
      <div>
        ...
        <div id="body">
          <Routes>
            ...
            <Route
              path="/ArticleEl/:id"
              element={<ArticleElem articles={this.state.articles} />}
            />
          </Routes>
        </div>
